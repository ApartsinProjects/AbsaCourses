...
NFAT = {
    ...
    "points": [
        ("1. Human validation of the audit on the synthetic corpus", "ok",
         ...
         "Section 5.7 (Table 15); Section 6.1."),
...
H7LN = {
    ...
    "points": [
        ("1. Statistical realism and full-schema re-annotation", "ok",
         ...
         "Section 5.7 (Table 15); Section 6.1; Appendix A.2.7."),
        ("2. Broaden baselines beyond one provider and prompt", "ok",
         ...
         "Appendix A.3.2; Appendix A.6.2."),
        ("3. Figure and table formatting", "ok",
         "The formatting of Figure 1, Table 5, Figure A3, and Figure A6 could benefit from refinement.",
...
DWED = {
    ...
    "points": [
        ("1. Generator-auditor circularity", "ok",
         ...
         "Section 6.1; Appendix A.3.2, A.4.4."),
