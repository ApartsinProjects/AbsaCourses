...
- 2026-06-05_c1_relabel.md — C1 label-removal cleaning: NEGATIVE (det -0.055, sentMSE +0.113 vs baseline); row-filtering (§5.9) is the right knob. diagnostic, not in paper.
- 2026-06-13_auroc_metric_reframe.md — internal AUROC micro 0.688/macro 0.681 (F1 0.276, balacc 0.623 reproduced); "F1 low" rebutted. completed
